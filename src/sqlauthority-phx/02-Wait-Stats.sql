...
/*
Following query collects SQL Server Query Wait Statistics and essentially 
shows us what is the major bottleneck for your SQL Server queries.

Resource: https://blog.sqlauthority.com/2011/02/01/sql-server-wait-stats-wait-types-wait-queues-day-0-of-28-2/
