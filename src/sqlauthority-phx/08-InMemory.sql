-- ------------------------------------------------------
-- Script 08: How to get started with OLTP In-Memory Table?
...
/*
Simple demo to showcase Memory Optimized Data with SQL 2014 and later
*/
...
-- https://docs.microsoft.com/en-us/sql/relational-databases/in-memory-oltp/sql-server-support-for-in-memory-oltp?view=sql-server-2017