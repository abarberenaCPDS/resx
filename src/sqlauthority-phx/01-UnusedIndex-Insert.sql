...
/*
In this example we will see effect of unused index on Insert Statement (Updating the table)
We will create indexes on table and see the performance degradation for Insert Statement
*/
USE tempdb
GO
-- Create Table
