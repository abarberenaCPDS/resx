...
SELECT ID, ID1, ID2
FROM WhereClause WITH(INDEX([IX_WhereClause_ID2]))
WHERE ID2 = 'E67' AND ID1 = 'A2C4'
GO
...
WHERE object_name(i.object_id) = 'WhereClause'
GROUP by i.object_id,i.index_id,i.name
ORDER By object_name(i.object_id),i.index_id
GO

-- Update the statistics for one index
UPDATE STATISTICS [dbo].[WhereClause] 
([IX_WhereClause_ID1_ID2]) WITH FULLSCAN
GO
-- Rebuild the index
ALTER INDEX [IX_WhereClause_ID1_ID2] 
ON [dbo].[WhereClause] 
REBUILD
GO
