...
namespace ServiceModelEx
{
   public static class GenericResolverInstaller
   {
      ...
      [MethodImpl(MethodImplOptions.NoInlining)]
      public static void AddGenericResolver(this ServiceHost host,Assembly callingAssembly,params Type[] typesToResolve)
      {
      ...
      [MethodImpl(MethodImplOptions.NoInlining)]
      public static void AddGenericResolver<T>(this ChannelFactory<T> factory,Assembly callingAssembly,params Type[] typesToResolve) where T : class
      {
         if(callingAssembly == null)
         {
            CallingAssembly = Assembly.GetCallingAssembly();
